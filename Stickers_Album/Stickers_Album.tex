...
\begin{document}
	...
	% Background image
	\AddToShipoutPictureBG*{\includegraphics[draft=false, width=\paperwidth,height=\paperheight]{ComfyUI_00001_.png}}
	\newpage
	...
	% Background image
	\AddToShipoutPictureBG*{\includegraphics[draft=false, width=\paperwidth,height=\paperheight]{ComfyUI_00002_.png}}
	\newpage
	...
	% Background image
	\AddToShipoutPictureBG*{\includegraphics[draft=false, width=\paperwidth,height=\paperheight]{ComfyUI_00003_.png}}
	\newpage
	...
	% Background image
	\AddToShipoutPictureBG*{\includegraphics[draft=false, width=\paperwidth,height=\paperheight]{ComfyUI_00004_.png}}
	\newpage
	...
	% Background image
	\AddToShipoutPictureBG*{\includegraphics[draft=false, width=\paperwidth,height=\paperheight]{ComfyUI_00005_.png}}
	\newpage
	...
	\begin{tabularx}{\linewidth}{X}
		\begin{center}
			...
			\begin{minipage}{0.8\linewidth}
				\raggedright
				Sorprende, nell'ultimo catalogo della Pinacoteca di Pesaro (1993), il declassamento ad opera anonima di questo intenso dipinto, la cui questione attributiva sembrava già ben indirizzata dalla critica precedente.
				
				L'opera fu riferita a Giovanni Giacomo Sementi nel 1806, all'atto dell'acquisizione per via ereditaria da parte di Maria Malvezzi Hercolani (citata come "Adone morto, Venere e Amore che piangono, del Sementi"). Come tale fu ancora ricordata da Bassani (1816) e catalogata nel 1824 ("Venere, Adone, con Amorino che piange, del Sementi").
				
				Nell'ultimo inventario della raccolta, risalente agli anni sessanta del XIX secolo, il dipinto sarebbe addirittura assurto al rango di un'opera di Guido Reni.
			\end{minipage}
		\end{center}
	\end{tabularx}
	
	% Background image
	\AddToShipoutPictureBG*{\includegraphics[draft=false, width=\paperwidth,height=\paperheight]{ComfyUI_00006_.png}}
	\newpage
	...
	% Background image
	\AddToShipoutPictureBG*{\includegraphics[draft=false, width=\paperwidth,height=\paperheight]{ComfyUI_00007_.png}}
